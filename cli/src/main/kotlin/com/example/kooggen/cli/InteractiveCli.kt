...
class InteractiveCli {
    fun collectSpec(): ProjectSpec {
        ...
        return ProjectSpec.fromArtifact(
            artifact = artifact,
    ...
    private fun askArtifact(): String = askWithValidation(
        prompt = "Project artifact",
        defaultValue = "com.example.hello",
        validator = InputValidators::validateArtifact
    )
